...
En évaluant les intégrales avant celle avec l'exponentielle, on voit qu'on peut essentiellement échanger l'ordre des intégrales pour réécrire (*trouver une meilleure formulation...)
